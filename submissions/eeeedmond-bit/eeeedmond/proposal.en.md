---
title: "JZ RE:STACK · TRACKSIDE FUTURES"
...
summary: "A pluggable, expandable urban platform system with embedded AI capabilities turns the Centennial Jing-Zhang heritage corridor into an open innovation network linking research, industry, commerce and everyday urban life."
...
![Overall spatial structure and open innovation spine](assets/figures/site-overview.en.png)
...
![Heritage public interface, slow mobility and blue-green system](assets/figures/mobility-bluegreen.en.png)
...
The first round creates one independently reviewable pilot package in each key area rather than spreading all nodes at once: Zhongzhiyuan tests the professional interface among research ground floors, campus lobbies and trackside public entry; the AI Origin Community tests open challenges, project support and talent-life services; Dazhongsi tests product trial, merchant co-creation and customer feedback. Each pilot must pass four gates: named demand and users; consent of rights holder and property manager; professional review of fire, structure, power and network; and signed opening/exit rules with named operator and technical owner.

| Stage | Core action | Responsible actors | Evidence for progression | Failure response |
|---|---|---|---|---|
| 0 Preparation | Confirm need, site, responsibility and data boundary | Demand owner, rights holder/property, operator | All four responsibilities named and risk list closed | Do not install or open |
| 1 90-day validation | One plug-in, limited scope, staffed operation | Operator and technical owner | Real use, repeated-use evidence and human review | Pause, revise or remove |
| 2 Stable district operation | Add compatible plug-ins and shared directory | District operator, firms and service actors | No unresolved high risk; maintenance staff and funds viable | Roll back or reduce hours |
| 3 Cross-district connection | Shared catalogues, events and project referrals | Joint platform and district owners | Referral result traceable; rights and data remain bounded | End interconnection without harming basic local service |
...
![Metric status, reference estimates and calibration path](assets/figures/metrics-evidence.en.png)
