...
成本与采购按“标准组件、场地接入、专业核查、年度运营”四个包管理。标准组件以平台基座、固定 AI 核心和插件为计量单元；场地接入单列结构、电力、网络、消防、无障碍和恢复费用；专业核查由相应资质团队报价；年度运营覆盖人员、维护、保险、内容与审计。现阶段不编造总投资，场地和运营主体确认后再形成工程量清单、至少三方询价和全生命周期成本表，并把维护与撤除费用同时纳入决策。
