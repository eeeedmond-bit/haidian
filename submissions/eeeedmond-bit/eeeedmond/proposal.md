...
![首轮三个并行试点、四阶段门槛与责任主体实施路线图（概念阶段实施框架）](assets/figures/implementation-roadmap.png)
...
政府和街道负责公共安全与政策协同，空间提供方与物业负责房间、通行和设施保障，企业、高校、商户与居民共同提出真实需求，运营团队负责服务目录、预约、项目转介和维护，技术团队对模型和产品结果负责。观察指标包括需求响应、重复使用、验证改进、商户支持、公共服务可用和运营可持续性。

首轮不是同时铺开全部节点，而是每个重点片区形成一个可独立评估的试点包：众智园验证“研发建筑首层—园区前厅—轨旁公共入口”的专业协作接口；AI 原点社区验证“开放课题—项目陪伴—人才生活服务”的持续协作接口；大钟寺验证“产品试用—商户共创—客户反馈”的市场接口。试点必须依次通过四道门槛：需求方和使用者明确、空间权利人与物业同意、消防结构电力网络经专业核查、运营者与技术责任人签署开放和退出规则；任一项缺失均不进入开放运行。

| 阶段 | 核心动作 | 责任主体 | 进入下一阶段的证据 | 失败处理 |
|---|---|---|---|---|
| 0—准备 | 确认需求、场地、责任与数据边界 | 需求方、产权/物业、运营方 | 四类责任均有实名主体，风险清单关闭 | 不安装、不开放 |
| 1—90 日验证 | 单一插件、小范围、人工值守 | 运营方与技术方 | 有真实使用记录、复用证据和人工复盘 | 暂停、修正或撤除插件 |
| 2—片区稳定运行 | 增加兼容插件并共享服务目录 | 片区运营方、企业与公共服务主体 | 无未关闭高风险事项，维护资金和人员可持续 | 回退到单插件或降低开放时段 |
| 3—跨区联动 | 三区目录互认、活动与项目转介 | 联合运营平台及各片区责任人 | 转介结果可追踪，权责和数据不越界 | 终止互联，不影响本地基本服务 |
...
实施阶段由百年京张 AI 创新带管委会牵头，负责年度计划、跨部门协调、试点审批、资金组合和绩效复核；街道及区级相关部门承担公共安全、遗产、规划建设、市场和居民沟通协同；产权方、园区与物业确认场地权利、开放时段和设施条件；专业运营机构负责需求目录、预约、项目转介、活动、商户和维护；技术集成方负责固定 AI 核心、网络安全、设备、版本和回退；具备相应资质的结构、消防、电气、无障碍和遗产专业单位负责签章核查；企业、高校、商户和城市居民分别作为需求方、共创方、使用者和反馈方参与。

| 首轮项目包 | 核心空间动作 | 牵头与直接责任 | 首轮可交付成果 |
|---|---|---|---|
| 统筹平台与开放服务目录 | 建立三区统一的需求、能力、场地、责任人和退出状态台账 | 管委会牵头，联合运营机构执行，区级部门与街道协同 | 1 套双语目录、1 套开放规则、1 套责任与版本台账 |
| 众智园并行试点 | 研发建筑首层或园区前厅配置 1 处 L 级协同平台，轨旁及月泉路接口配置 2—4 处 S/M 节点 | 管委会与园区/产权方牵头，物业、科研企业和技术方实施 | 联合课题、接口联调、轻型验证和专业转介闭环 |
| AI 原点社区并行试点 | 街角、院落或活跃首层配置 1 处 L 级项目共创平台和 3—5 处 S/M 节点 | 管委会与街道牵头，产权/物业、运营方、企业和社区服务主体实施 | 开放课题、项目陪伴、人才生活服务和公众学习闭环 |
| 大钟寺并行试点 | 商业中庭或既有首层配置 1 处 L 级市场验证平台，预留 XL 升级接口，并配置 2—4 处 S/M 节点 | 管委会与商业产权/运营方牵头，商户、企业和技术方实施 | 产品试用、商户共创、企业采购体验和客户反馈闭环 |
| 遗产廊道公共接口 | 在不覆盖铁路遗存的前提下设置导览、休憩、便民和跨向连接节点 | 管委会协调，公园管理、遗产专业单位、街道和运营方共同负责 | 连续公共界面、遗产展示、无障碍服务和节点导向系统 |
...
稳定运行后，直接经营收入及企业服务、场地、活动和品牌合作收入预估可覆盖年度运营成本的 **40%—70%**；首轮试点期约为 **20%—40%**，其余公共服务和遗产文化部分由政府购买服务、园区和物业运营投入、企业联合课题及社会合作共同承担。年度效益参考区间为 2—5 万人次参与、30—80 项需求匹配、10—30 项轻型验证或产品改进、15—40 家企业或商户参与。上述效益不是招商、交易或投资回报承诺，正式绩效值须在 90 日试点形成真实基线后由管委会审核确定。
